  ...
  select case (trim(name))
	...
	write(*, *) ""
     ...
     case('stat')
        ...
        write(*, *) "Options: "
        write(*, *) ""
        write(*, *) "-ac              prints autocorrelation profile"
        write(*, *) ""
        write(*, *) "-mbb             prints Moving Block Bootstrap profile"
        write(*, *) "and requires the block size to be used in the protocol"
        write(*, *) ""
        write(*, *) "-help            prints HELP information and quits"
        stop
     ...
     case('comp')
        ...
        write(*, *) ""
        write(*, *) "Usage: s_comp -true file.xvg -proj file2.xvg -size N -temp T "
        write(*, *) "       -ac corr_time"
        write(*, *) ""
        write(*, *) "file.xvg ---- contains a SuAVE output for total membrane area"
        write(*, *) "N ----------- defines the number of frames to be used in the"
        write(*, *) "area compressibility and bending modulus estimation"
        write(*, *) "T ----------- temperature in which the simulation was performed"
        write(*, *) "and that will be used in the elastic property estimation"
        write(*, *) "corr_time --- autocorrelation time (in frames) that will be used"
        write(*, *) "for the Moving Block Bootstrap protocol"
        write(*, *)
        write(*, *) "Options: "
        write(*, *) ""
        write(*, *) "-help            prints HELP information and quits"
